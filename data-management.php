                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        ...
                                        <div class="card border-hover-primary">
                                            ...
                                            <div class="card-body p-9">
                                                ...
                                                <a href="user-overview.php?year=2024&progress=100" class="btn btn-primary mx-auto mt-8 d-block" type="button">View Data</a>
                                            </div>
                                            <!--end:: Card body-->
                                        </div>
                                        <!--end::Card-->
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        ...
                                        <div class="card border-hover-primary">
                                            ...
                                            <div class="card-body p-9">
                                                ...
                                                <a href="user-overview.php?year=2025&progress=37" class="btn btn-primary mx-auto mt-8 d-block" type="button">View Data</a>
                                            </div>
                                            <!--end:: Card body-->
                                        </div>
                                        <!--end::Card-->
