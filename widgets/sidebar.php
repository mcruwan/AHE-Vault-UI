                ...
                <div class="border border-gray-300 border-dashed rounded min-w-100px w-100 p-4 mb-3">
                    ...
                    <div class="d-flex w-100 mt-2">
                        ...
                        <div class="fw-semibold fs-7 text-primary w-50 text-right">
                            <a href="university-edit.php">Complete profile</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="app-footer-item me-6">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                ...
                <div class="py-2 text-center border-top">
                    <a href="pages/user-profile/activity.html" class="btn btn-color-gray-600 btn-active-color-primary">View All <i class="ki-outline ki-arrow-right fs-5"></i></a>
                </div>
                <!--end::View more-->
            </div>
            <!--end::Menu-->
